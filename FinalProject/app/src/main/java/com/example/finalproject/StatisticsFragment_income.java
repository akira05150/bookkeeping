...
//import
public class StatisticsFragment_income extends Fragment {

    @NonNull
    public static Fragment newInstance() {
        return new StatisticsFragment_income();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //預設支出
        inorout = getResources().getString(R.string.str_income);
        ...
        txv.setText(cyear+"/"+cmonth+getResources().getString(R.string.str_mincome));
...
//                return true;
                ...
                MonthPickerDialog.Builder builder1 = new MonthPickerDialog.Builder(getActivity(),
                        new MonthPickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(int selectedMonth, int selectedYear) {
                                cyear = selectedYear;
                                cmonth = 0;
                                txv.setText(cyear + getResources().getString(R.string.str_yincome));
    ...
    private SpannableString generateCenterText(String t) {
        SpannableString s = new SpannableString(getResources().getString(R.string.str_income)+"\n"+t);//為何長度不夠就搞我==
